...
def organize_lines_from_a_CSV_file_into_a_data_frame(the_path_to_the_CSV_file_to_use, the_index_of_the_first_line, the_index_of_the_second_line, the_list_of_columns_as_string, should_print_data_frame):
    ...
    try:
        ...
        the_CSV_file_organizer.provides_a_dataframe_representing_the_lines_of_the_CSV_file(the_index_of_the_first_line, the_index_of_the_second_line, list_of_columns, should_print_data_frame)
    except An_Invalid_Line_Indices_Exception as the_invalid_line_indices_exception:
        print(the_invalid_line_indices_exception)
        exit()
...
def parse_arguments():
    ...
    parser.add_argument('the_path_to_the_CSV_file_to_use', type = str, help = 'the path to the CSV file to use')
    parser.add_argument('the_index_of_the_first_line', type = int, help = 'the index of the first line')
    parser.add_argument('the_index_of_the_second_line', type = int, help = 'the index of the second line')
    parser.add_argument('-l', '--the_list_of_columns_as_string', type = str, help = 'the list of columns as string')
    parser.add_argument('-v', '--verbose', action = 'store_true', help = 'Allow printing data frame')
    ...
    should_print_data_frame = args.verbose
    ...
    print(f'should print data frame: {should_print_data_frame}')
    ...
    dictionary_of_arguments['should_print_data_frame'] = should_print_data_frame
...
if __name__ == "__main__":
    ...
    organize_lines_from_a_CSV_file_into_a_data_frame(
        ...
        should_print_data_frame = dictionary_of_arguments['should_print_data_frame']
    )